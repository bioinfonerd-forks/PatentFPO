...
if __name__ == '__main__':
    # fetch_detail('http://www.freepatentsonline.com/y2017/
    start = time.time()

    # p1 = Thread(target=lets_rock, args=(company_list1, ))
    # p2 = Thread(target=lets_rock, args=(company_list2, ))
    # p3 = Thread(target=lets_rock, args=(company_list3, ))
    # #
    # p1.start()
    # p2.start()
    # p3.start()
    ...
    gevent.joinall([
        gevent.spawn(lets_rock, company_list1),
        gevent.spawn(lets_rock, company_list2),
        gevent.spawn(lets_rock, company_list3),
    ])
